    ...
    <div className='min-h-screen px-4 py-12 sm:px-6 lg:px-8'>
      <div className='mx-auto max-w-3xl space-y-8'>
        ...
        <section>
          ...
          <p className='text-muted-foreground text-base leading-relaxed'>
            Authentication is currently a local development mock. It accepts any email and password
            and stores a temporary session cookie so the dashboard can be shaped before production
