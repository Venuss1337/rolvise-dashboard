      ...
      <div className='mx-auto max-w-3xl'>
        ...
        <div className='space-y-8'>
          ...
          <section className='bg-card rounded-2xl border p-8 shadow-sm'>
            ...
            <p className='text-muted-foreground text-lg leading-relaxed'>
              Authentication is currently mocked for local development. Any email and password can
              create a temporary session while the ER:LC community management workflows are built.
            </p>
          </section>
